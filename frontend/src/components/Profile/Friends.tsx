...
const Friends = () => {
  return (
    <div>
      <h3 className="text-center text-3xl font-bold">Top Friends</h3>
      <div className="flex flex-row gap-5 justify-center mt-5">
        <Link
          href="/dashboard/friends/user-name"
          className="shadow-md px-3 py-2 rounded-md flex flex-col gap-2 items-center hover:bg-amber-300"
        >
          <Avatar />
